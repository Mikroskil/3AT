<html>
<head>
<title>Memberi Komentar pada salah satu forum</title>
</head>
<body>
<?php
$host="localhost"; 
...
<tr>
<td bgcolor="#F8F7F1"><strong>By :</strong> <?php echo $rows['name']; ?> <br>
<strong>Email : </strong><?php echo $rows['email'];?></td>
</tr>
<tr>
<td bgcolor="#F8F7F1"><strong>Date/time : </strong><?php echo $rows['datetime'];
?></td>
</tr>
</table></td>
</tr>
...
bgcolor="#FFFFFF">
<tr>
<td width="18%" bgcolor="#F8F7F1"><strong>NO</strong></td>
...
<p align="center"><a href="main_forum.php">Batal dan Kembali Ke Forum Utama
</a></p>
</body>
</html>