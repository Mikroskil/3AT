...
<div id="isi">
<div id="kiri">
<div id="judul">Tentang Kami, Wifotran Lasal</div>
<h1>Apa sih Wifotran Lasal itu???</h1>
Wifotran Lasal adalah sebuah website yang menawarkan jasa pemeasanan lapangan secara online.<br /><br />
Lho, maksudnya gimana?<br /><br />
Jadi, Wifotran Lasal memberikan kemudahan bagi para pengunjung yang ingin memesan lapangan futsal dan juga terdapat latihan dan kompetisi.
<br /><br />
<h1>WOW Keren, Bisa dilihat jadwalnya???</h1>
Gampang banget! Pilih menu jadwal dan kompetisi.<br /><br />
<h1>Terus, adakah forum khusus untuk bertanya?</h1>
Tentu saja, pilih saja menu Masuk Ke Forum.<br /><br />
</div>
<div id="kanan">
...
<li class="li-class-no">Jl. Thamrin No. 32 A-Z
</li>
...
<div id="menu-bawah">
<div id="footer">Copyright © Wifotran Lasal Clothing 2013. All Right Reserved</div>
</div>
</body>
</html>